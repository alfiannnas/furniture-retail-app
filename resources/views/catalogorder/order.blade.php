                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">
                                            @if (!empty($order->evidencetf2))
                                                <div
                                                    class="inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md ">
                                                    Selesai
                                                </div>
                                            @elseif ($order->full_payment == 'uploadbuktitf')
                                                <a href="/order/evidencetf2/{{ $order->id }}" disabled
                                                    ...
                                                    Upload Pelunasan</a>
                                            @elseif ($order->full_payment == 'COD')
                                                <div
                                                    class="inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md ">
                                                    COD
                                                </div>
                                            @elseif ($order->payment_status == 'DP')
                                                <a href="/fullpayment/{{ $order->id }}"
                                                    class="inline-block px-6 py-2.5 bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-yellow-600 hover:shadow-lg focus:bg-yellow-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out"
                                                    type="button">
                                                    Pelunasan
                                                </a>
                                        ...
                                        <td class="px-4 py-3">
                                            <a href="/order/detail/{{ $order->id }}" data-mdb-ripple="true"
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-sm text-center">
                    ...
                    <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Silahkan
                        pesan produk terlebih dahulu</p>
                    <a href="/catalog"
                        class="inline-flex text-white bg-third hover:bg-four focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center my-4">Kunjungi
                        Katalog</a>
                </div>
            </div>
        @endif
